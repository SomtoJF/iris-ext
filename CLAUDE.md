...
- Panel clears scanned fields on tab URL change (content script dies on navigation; rescan re-injects). The application session stays on the tab until the user goes home or the tab closes.
